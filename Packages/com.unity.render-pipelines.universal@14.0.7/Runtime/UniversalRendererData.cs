...
// extensions modify begin;
        [SerializeField] bool m_MixGammaColorSpace;
        [SerializeField] LayerMask m_GammaOpaqueLayerMask = 0;
        [SerializeField] LayerMask m_GammaTransparentLayerMask = 0;
...
// extensions modify begin;
        public bool MixGammaColorSpace
        {
            get => m_MixGammaColorSpace;
            set
            {
                SetDirty();
                m_MixGammaColorSpace = value;
            }
        }

        public LayerMask GammaOpaqueLayerMask
        {
            get => m_GammaOpaqueLayerMask;
            set
            {
                SetDirty();
                m_GammaOpaqueLayerMask = value;
            }
        }

        public LayerMask GammaTransparentLayerMask
        {
            get => m_GammaTransparentLayerMask;
            set
            {
                SetDirty();
                m_GammaTransparentLayerMask = value;
            }
        }
// extensions modify end;

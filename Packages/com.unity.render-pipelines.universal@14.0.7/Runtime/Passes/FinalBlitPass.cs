...
// extensions modify begin;
                if (m_SrgbSource && cameraData.requireSrgbConversion)
                {
                ...
                else
                {
                    ...
                    CoreUtils.SetKeyword(cmd, ShaderKeywordStrings.SRGBToLinearConversion, m_SrgbSource);
                }
// extensions modify end;
                if (outputsToHDR)
                {

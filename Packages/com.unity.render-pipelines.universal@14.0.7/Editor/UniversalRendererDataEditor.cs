...
// extensions modify begin; 
            public static readonly GUIContent MixGammaColorSpaceLable = EditorGUIUtility.TrTextContent("Mix Gamma Color Space", "Enable the render support mix gamma color space when player setting is linear color space.");
            public static readonly GUIContent GammaOpaqueLayerMask = EditorGUIUtility.TrTextContent("Gamma Opaque Layer Mask", "Controls which Opaque layers in gamma space this renderer draws.");
            public static readonly GUIContent GammaTransparentMask = EditorGUIUtility.TrTextContent("Gamma Transparent Layer Mask", "Controls which transparent layers in gamma space this renderer draws.");
...
// extensions modify begin;
        SerializedProperty m_MixGammaColorSpace;
        SerializedProperty m_GammaOpaqueLayerMask;
        SerializedProperty m_GammaTransparentLayerMask;
// extensions modify end;
...
// extensions modify begin;
            m_MixGammaColorSpace = serializedObject.FindProperty("m_MixGammaColorSpace");
            m_GammaOpaqueLayerMask = serializedObject.FindProperty("m_GammaOpaqueLayerMask");
            m_GammaTransparentLayerMask = serializedObject.FindProperty("m_GammaTransparentLayerMask");
// extensions modify end;
...
// extensions modify begin;
            ...
            EditorGUI.indentLevel++;
            {
                EditorGUILayout.PropertyField(m_MixGammaColorSpace, Styles.MixGammaColorSpaceLable);
                if (m_MixGammaColorSpace.boolValue)
                {
                    EditorGUI.indentLevel++;
                    EditorGUILayout.PropertyField(m_GammaOpaqueLayerMask, Styles.GammaOpaqueLayerMask);
                    EditorGUILayout.PropertyField(m_GammaTransparentLayerMask, Styles.GammaTransparentMask);
                    EditorGUI.indentLevel--;
                }
            }
            EditorGUI.indentLevel--;

          ...
          ICanvasElement
    {
        ...
        static public Material defaultGraphicMaterial
        {
            get
            {
                if (s_DefaultUI == null)
                {
                    Shader shader = Shader.Find("UI/DefaultEx");
                    if (shader != null)
                    {
...
// extensions modify begin;
        [SerializeField] private bool m_GrayScale;
...
// extensions modify begin;
        public virtual bool grayScale { get => m_GrayScale; set { if (m_GrayScale != value) { m_GrayScale = value; SetVerticesDirty(); } } }
// extensions modify end;
...
// extensions modify begin;
            Color32 color32 = grayScale ? new Color(0.5f, 0.5f, 0.5f, color.a) : color;
// extensions modify begin;
            vh.Clear();

...
// extensions modify begin;
                    ...
                    if (grayScale)
                    {
                        if (texture == null)
                        {
                            color32 = new Color(0.5f, 0.5f, 0.5f, color32.a);
                            gray = 0f;
                        }
                        else
                        {
                    ...
                    vh.AddVert(new Vector3(v.x, v.y), color32, new Vector4(m_UVRect.xMin * scaleX, m_UVRect.yMin * scaleY, gray));
                    vh.AddVert(new Vector3(v.x, v.w), color32, new Vector4(m_UVRect.xMin * scaleX, m_UVRect.yMax * scaleY, gray));
                    vh.AddVert(new Vector3(v.z, v.w), color32, new Vector4(m_UVRect.xMax * scaleX, m_UVRect.yMax * scaleY, gray));
                    vh.AddVert(new Vector3(v.z, v.y), color32, new Vector4(m_UVRect.xMax * scaleX, m_UVRect.yMin * scaleY, gray));
